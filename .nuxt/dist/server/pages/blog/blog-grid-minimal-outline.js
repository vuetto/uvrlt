...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/blog-grid-minimal-outline.vue?vue&type=template&id=854354b2&
var render = function render() {
  ...
  }), _vm._ssrNode(" <div class=\"breadcrumb-area pt--260 pb--80 pt_md--200 pt_sm--150 breadcrumb-title-bar\"><div class=\"container\"><div class=\"row\"><div class=\"col-lg-12\"><div class=\"breadcrumb-inner text-center\"><h1 class=\"heading heading-h1\">Grid Minimal Outline</h1></div></div></div></div></div> "), _vm._ssrNode("<div class=\"bk-blog-grid-area pt--100 pb--100 pt_md--80 pb_md--80 pb_sm--80 pt_sm--60\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-8 mtn--60\">", "</div>", [_vm._ssrNode("<div class=\"row row--30\">", "</div>", _vm._l(_vm.data.blogs.slice(3, 15), function (blog) {
    return _vm._ssrNode("<div class=\"col-sm-6 move-up wow mt--60\">", "</div>", [_vm._ssrNode("<div class=\"blog-grid-minimal outline\">", "</div>", [_vm._ssrNode("<div class=\"grid-overlay\"" + _vm._ssrStyle(null, {
      backgroundImage: `url(${blog.image})`
    }, null) + "></div> "), _vm._ssrNode("<div class=\"post-content\">", "</div>", [_vm._ssrNode("<h5 class=\"heading\">", "</h5>", [_c('n-link', {
      attrs: {
        "to": `/blog/${blog.slug}`
      }
    }, [_vm._v("\n                                            " + _vm._s(blog.title) + "\n                                        ")])], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"post-meta\">", "</div>", [_vm._ssrNode("<div class=\"post-date\">" + _vm._ssrEscape(_vm._s(blog.date)) + "</div> "), _vm._ssrNode("<div class=\"post-category\">", "</div>", _vm._l(blog.categories.slice(0, 1), function (category, i) {
      return _c('n-link', {
        key: i,
        attrs: {
  ...
  }), 0), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"brook-pagination-wrapper text-center pt--80\">", "</div>", [_c('paginate', {
    attrs: {
      "page-count": 4,
      "page-range": 3,
      "margin-pages": 2,
  ...
  })], 1)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-lg-4 mt_md--40 mt_sm--40\">", "</div>", [_c('BlogSidebar')], 1)], 2)])]), _vm._ssrNode(" "), _c('FooterTwo')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/blog/blog-grid-minimal-outline.vue?vue&type=template&id=854354b2&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/blog-grid-minimal-outline.vue?vue&type=script&lang=js&


/* harmony default export */ var blog_grid_minimal_outlinevue_type_script_lang_js_ = ({
  ...
  components: {
    ...
    BlogPostFour: () => __webpack_require__.e(/* import() */ 28).then(__webpack_require__.bind(null, 159)),
...
// CONCATENATED MODULE: ./pages/blog/blog-grid-minimal-outline.vue?vue&type=script&lang=js&
 /* harmony default export */ var blog_blog_grid_minimal_outlinevue_type_script_lang_js_ = (blog_grid_minimal_outlinevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/blog/blog-grid-minimal-outline.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  blog_blog_grid_minimal_outlinevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var blog_grid_minimal_outline = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=blog-grid-minimal-outline.js.map
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/tag/_slug.vue?vue&type=template&id=ce52f212&
var render = function render() {
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"bk-blog-grid-area pt--70 pb--100 pt_md--80 pb_md--80 pb_sm--80 pt_sm--60 bg_color--5\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-8\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", _vm._l(_vm.posts, function (blog, i) {
    return _vm._ssrNode("<div class=\"col-sm-6 move-up wow mt--30\">", "</div>", [_vm._ssrNode("<div class=\"blog-grid\">", "</div>", [_vm._ssrNode("<div class=\"post-thumb\">", "</div>", [_c('n-link', {
      attrs: {
        "to": `/blog/${blog.slug}`
      }
    }, [_c('img', {
  ...
  }), 0), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-12\">", "</div>", [_vm._ssrNode("<div class=\"brook-pagination-wrapper text-center pt--80 pt_md--40 pt_sm--40\">", "</div>", [_c('paginate', {
    attrs: {
      "page-count": 4,
      "page-range": 3,
      "margin-pages": 2,
  ...
  })], 1)])])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-lg-4 mt_md--40 mt_sm--40 mt--30\">", "</div>", [_c('BlogSidebar')], 1)], 2)])]), _vm._ssrNode(" "), _c('FooterTwo')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/blog/tag/_slug.vue?vue&type=template&id=ce52f212&
  ...
  computed: {
    posts() {
      return this.data.blogs.filter(post => {
        var _post$tags;
        return post === null || post === void 0 ? void 0 : (_post$tags = post.tags) === null || _post$tags === void 0 ? void 0 : _post$tags.includes(this.slug.split("-").join(" "));
      });
    }
  },
  mounted() {

...
import nuxt_plugin_bootstrapvue_e163b6ec from 'nuxt_plugin_bootstrapvue_e163b6ec' // Source: ./bootstrap-vue.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Ugo Varlet","titleTemplate":"Ugo V. || %s","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_bootstrapvue_e163b6ec === 'function') {
    await nuxt_plugin_bootstrapvue_e163b6ec(app.context, inject)
  }

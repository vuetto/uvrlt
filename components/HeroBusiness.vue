    ...
    <div class="slider-area hero-business position-relative">
        <div class="number-dot">
            <swiper :options="swiperOption">
                <div class="hero-item bg-image swiper-slide" :style="{ backgroundImage: `url('/img/slider/test.jpg')` }">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="hero-content-2">
                                    <h3>Ugo Varlet <br><span style="font-family: 'Playfair Display', serif;"><i>Tech Copywriter</i></span></h3>
                                </div>
                            </div>
                        </div>
                    </div>

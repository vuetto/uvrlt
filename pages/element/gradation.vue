<template>
    <div class="main-wrapper">
        ...
        <Breadcrumb :items="items" title="Gradation" />

        <div class="brook-gradation-area ptb--150 ptb-md--80 ptb-sm--60 basic-thine-line">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="brook-section-title text-center">
                            <h4 class="heading heading-h4">Default Color</h4>
                        </div>
                        <GradationOne />
                    </div>
                </div>

<template>
    <div class="main-container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-inner text-center">
                            <h1 class="heading heading-h1">Standard List</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="blog-creative-area bg_color--5 pt--70 pb--100">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mtn--70">
                        <div class="creative-blog wow move-up mt--70" v-for="blog in data.blogs.slice(16, 20)" :key="blog.id">
                            <BlogPostFour :blog="blog" addClass="blog-standard-list" />
                        </div>

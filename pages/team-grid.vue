<template>
    <div class="main-container">
        ...
        <div class="brook-team-area bg_color--1">
            <div class="container">
                <div class="row row--30 mtn--40">
                    <div class="col-md-4 col-sm-6 mt--40" v-for="teamMember in data.teamMembers.slice(7, 10)" :key="teamMember.id">

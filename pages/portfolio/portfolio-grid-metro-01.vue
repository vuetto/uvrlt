<template>
    <div class="main-container">
        ...
        <div class="portfolio-grid-metro mesonry-list mt--70">
             <no-ssr>
                <div v-masonry transition-duration="3s" item-selector=".portfolio" class="masonry-hjknk">
